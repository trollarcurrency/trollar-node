...
char const * default_live_peer_network = "::ffff:147.135.115.99";
	...
	external_address{ boost::asio::ip::address_v6{}.to_string () }
{
	...
	switch (network_params.network.network ())
	{
		...
		case nano::networks::nano_beta_network:
		{
			...
			release_assert (!offline_representative.decode_account ("troll_1defau1t9off1ine9rep99999999999999999999999999999999wgmuzxxy"));
		...
		case nano::networks::nano_live_network:
			...
			preconfigured_representatives.emplace_back ("619646A86BF65EA3941C8EEA5EA5BADE29CC6663D1F9EA1F47BEA65A4660290B");
