...
// SI dividers
nano::uint128_t const Gxrb_ratio = nano::uint128_t ("100000000000000000000000000000000"); // 10^32
nano::uint128_t const Mxrb_ratio = nano::uint128_t ("100000000000000000000000000000"); // 10^29
nano::uint128_t const kxrb_ratio = nano::uint128_t ("100000000000000000000000000"); // 10^26
nano::uint128_t const xrb_ratio = nano::uint128_t ("100000000000000000000000"); // 10^23
